  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="text-center pt-12 pb-8">
        <Link href="/" className="font-display-lg text-headline-md text-on-surface uppercase tracking-tighter hover:text-primary transition-colors inline-block">
          FACELESS
        </Link>
      </div>
      <div className="flex-grow flex flex-col items-center justify-center px-margin-mobile md:px-margin-desktop pb-section-gap">
        ...
        <Link href="/library" className="bg-primary text-[#0A0A0A] font-label-caps text-label-caps px-12 py-4 uppercase tracking-[0.2em] hover:brightness-110 transition-all inline-block mb-6 animate-fade-in">
          Vào Thư Viện
        </Link>
