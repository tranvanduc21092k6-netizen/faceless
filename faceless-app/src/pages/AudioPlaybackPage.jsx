      ...
      <section className="w-full max-w-3xl mt-section-gap">
        <div className="mb-gutter text-center">
          ...
          <p className="font-body-lg text-body-lg text-on-surface-variant">
            A dialectical synthesis on the spaces between words, generated by autonomous inquiry.
          </p>
        </div>
          ...
          <div className="relative z-10 flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="hidden sm:flex items-center gap-4">
                <button aria-label="Rewind 10 seconds" className="text-on-surface-variant hover:text-primary transition-colors">
                  <span className="material-symbols-outlined">replay_10</span>
                </button>
                <button aria-label="Forward 10 seconds" className="text-on-surface-variant hover:text-primary transition-colors">
                  <span className="material-symbols-outlined">forward_10</span>
                </button>
                <button aria-label="Volume" className="text-on-surface-variant hover:text-primary transition-colors">
        ...
        <div className="flex gap-2 mt-6 flex-wrap">
          <span className="bg-[#222222] text-on-surface font-label-caps text-label-caps px-3 py-1 uppercase">Synthesis</span>
          <span className="bg-[#222222] text-on-surface font-label-caps text-label-caps px-3 py-1 uppercase">Model: OMEGA-7</span>
          <span className="bg-[#222222] text-on-surface font-label-caps text-label-caps px-3 py-1 uppercase">Duration: 5M</span>
        </div>
      </section>
    </div>
  )
